...
namespace TestNextSiblingUI
{
    ...
    public class CodedUITest1
    {
        ...
        {
            var aut = ApplicationUnderTest.Launch(@"D:\dropbox\Dropbox\marcel-devries\CodedUI\Demos\UsingNextSibling\TestNextSiblingUIWin\bin\Debug\UsingNextSiblingWin.exe");
